...
Ext.define('AccountManager.view.resource.EditView', {
    ...
    initComponent: function() {
        ...
        me.form = Ext.create('Ext.form.Panel', {
            ...
            waitTitle: '请等待...',
            api: {
                submit: AccountManager.Direct.Resource.add
            },
            fieldDefaults: {
                labelWidth: 35,
                labelSeparator: ':',
            ...
            f.submit({
                ...
                success: function(form, action) {
                    var me = this,
                        ...
                        f = me.form.getForm(),
                        store = Ext.StoreManager.lookup('Resource'),
                        rec = f.getRecord();
                    f.updateRecord(rec);
                    ...
                    rec.set('Name', result.data.Name);
                    rec.set('Description', result.data.Description);
                    rec.set('UpdateTime', result.data.UpdateTime);
                    rec.commit();
                    me.close();
                    // clear form
                    m = store.model;
