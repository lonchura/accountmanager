...
use Propel\UserPeer;
use Propel\map\AccountTableMap;
...
abstract class BaseAccountPeer
{
    ...
    const OM_CLASS = 'Propel\\Account';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Propel\\map\\AccountTableMap';
    ...
    const CREATE_TIME = 'account.create_time';

    /** the column name for the update_time field */
    const UPDATE_TIME = 'account.update_time';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Identifier', 'Password', 'CreateTime', 'UpdateTime', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'identifier', 'password', 'createTime', 'updateTime', ),
        BasePeer::TYPE_COLNAME => array (AccountPeer::ID, AccountPeer::USER_ID, AccountPeer::IDENTIFIER, AccountPeer::PASSWORD, AccountPeer::CREATE_TIME, AccountPeer::UPDATE_TIME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'IDENTIFIER', 'PASSWORD', 'CREATE_TIME', 'UPDATE_TIME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'identifier', 'password', 'create_time', 'update_time', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Identifier' => 2, 'Password' => 3, 'CreateTime' => 4, 'UpdateTime' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'identifier' => 2, 'password' => 3, 'createTime' => 4, 'updateTime' => 5, ),
        BasePeer::TYPE_COLNAME => array (AccountPeer::ID => 0, AccountPeer::USER_ID => 1, AccountPeer::IDENTIFIER => 2, AccountPeer::PASSWORD => 3, AccountPeer::CREATE_TIME => 4, AccountPeer::UPDATE_TIME => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'IDENTIFIER' => 2, 'PASSWORD' => 3, 'CREATE_TIME' => 4, 'UPDATE_TIME' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'identifier' => 2, 'password' => 3, 'create_time' => 4, 'update_time' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccountPeer::CREATE_TIME);
            $criteria->addSelectColumn(AccountPeer::UPDATE_TIME);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseAccountPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Propel\map\AccountTableMap());
      }
    }
