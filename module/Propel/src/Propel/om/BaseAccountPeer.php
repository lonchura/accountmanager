...
abstract class BaseAccountPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Identifier', 'Password', 'CreateTime', 'UpdateTime', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'identifier', 'password', 'createTime', 'updateTime', ),
        BasePeer::TYPE_COLNAME => array (AccountPeer::ID, AccountPeer::IDENTIFIER, AccountPeer::PASSWORD, AccountPeer::CREATE_TIME, AccountPeer::UPDATE_TIME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IDENTIFIER', 'PASSWORD', 'CREATE_TIME', 'UPDATE_TIME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'identifier', 'password', 'create_time', 'update_time', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Identifier' => 1, 'Password' => 2, 'CreateTime' => 3, 'UpdateTime' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'identifier' => 1, 'password' => 2, 'createTime' => 3, 'updateTime' => 4, ),
        BasePeer::TYPE_COLNAME => array (AccountPeer::ID => 0, AccountPeer::IDENTIFIER => 1, AccountPeer::PASSWORD => 2, AccountPeer::CREATE_TIME => 3, AccountPeer::UPDATE_TIME => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IDENTIFIER' => 1, 'PASSWORD' => 2, 'CREATE_TIME' => 3, 'UPDATE_TIME' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'identifier' => 1, 'password' => 2, 'create_time' => 3, 'update_time' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
