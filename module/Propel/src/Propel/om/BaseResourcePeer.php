...
abstract class BaseResourcePeer
{
    ...
    const TYPE__WEBSITE_ = ''Website'';
    const TYPE__DATABASE_ = ''Database'';
    const TYPE__SERVER_ = ''Server'';
    const TYPE__PAYMENT_ = ''Payment'';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Identifier', 'Type', 'Name', 'Description', 'CreateTime', 'UpdateTime', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'identifier', 'type', 'name', 'description', 'createTime', 'updateTime', ),
        BasePeer::TYPE_COLNAME => array (ResourcePeer::ID, ResourcePeer::IDENTIFIER, ResourcePeer::TYPE, ResourcePeer::NAME, ResourcePeer::DESCRIPTION, ResourcePeer::CREATE_TIME, ResourcePeer::UPDATE_TIME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'IDENTIFIER', 'TYPE', 'NAME', 'DESCRIPTION', 'CREATE_TIME', 'UPDATE_TIME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'identifier', 'type', 'name', 'description', 'create_time', 'update_time', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Identifier' => 1, 'Type' => 2, 'Name' => 3, 'Description' => 4, 'CreateTime' => 5, 'UpdateTime' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'identifier' => 1, 'type' => 2, 'name' => 3, 'description' => 4, 'createTime' => 5, 'updateTime' => 6, ),
        BasePeer::TYPE_COLNAME => array (ResourcePeer::ID => 0, ResourcePeer::IDENTIFIER => 1, ResourcePeer::TYPE => 2, ResourcePeer::NAME => 3, ResourcePeer::DESCRIPTION => 4, ResourcePeer::CREATE_TIME => 5, ResourcePeer::UPDATE_TIME => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'IDENTIFIER' => 1, 'TYPE' => 2, 'NAME' => 3, 'DESCRIPTION' => 4, 'CREATE_TIME' => 5, 'UPDATE_TIME' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'identifier' => 1, 'type' => 2, 'name' => 3, 'description' => 4, 'create_time' => 5, 'update_time' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    protected static $enumValueSets = array(
        ResourcePeer::TYPE => array(
            ResourcePeer::TYPE__WEBSITE_,
            ResourcePeer::TYPE__DATABASE_,
            ResourcePeer::TYPE__SERVER_,
            ResourcePeer::TYPE__PAYMENT_,
        ),
    );
