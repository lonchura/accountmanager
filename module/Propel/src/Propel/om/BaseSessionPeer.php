...
use Propel\map\SessionTableMap;
...
abstract class BaseSessionPeer
{
    ...
    const OM_CLASS = 'Propel\\Session';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Propel\\map\\SessionTableMap';
    ...
    const CREATE_TIME = 'session.create_time';

    /** the column name for the update_time field */
    const UPDATE_TIME = 'session.update_time';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CreateTime', 'UpdateTime', 'Data', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'createTime', 'updateTime', 'data', ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::ID, SessionPeer::NAME, SessionPeer::CREATE_TIME, SessionPeer::UPDATE_TIME, SessionPeer::DATA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'CREATE_TIME', 'UPDATE_TIME', 'DATA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'create_time', 'update_time', 'data', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CreateTime' => 2, 'UpdateTime' => 3, 'Data' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'createTime' => 2, 'updateTime' => 3, 'data' => 4, ),
        BasePeer::TYPE_COLNAME => array (SessionPeer::ID => 0, SessionPeer::NAME => 1, SessionPeer::CREATE_TIME => 2, SessionPeer::UPDATE_TIME => 3, SessionPeer::DATA => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'CREATE_TIME' => 2, 'UPDATE_TIME' => 3, 'DATA' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'create_time' => 2, 'update_time' => 3, 'data' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionPeer::CREATE_TIME);
            $criteria->addSelectColumn(SessionPeer::UPDATE_TIME);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseSessionPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Propel\map\SessionTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SessionPeer::NAME);
            $value = $criteria->remove(SessionPeer::NAME);
            if ($value) {
                $selectCriteria->add(SessionPeer::NAME, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SessionPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(SessionPeer::NAME, $value[1]));
    ...
    public static function retrieveByPK($id, $name, PropelPDO $con = null) {
        ...
        $criteria->add(SessionPeer::NAME, $name);
