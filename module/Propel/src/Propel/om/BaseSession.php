...
abstract class BaseSession extends BaseObject implements Persistent
{
    ...
    public function setCreateTime($v)
    {
        ...
        if ($this->create_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SessionPeer::CREATE_TIME;
            }
    ...
    public function setUpdateTime($v)
    {
        ...
        if ($this->update_time !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SessionPeer::UPDATE_TIME;
            }
        } // if either are not null
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SessionPeer::CREATE_TIME)) {
                    $this->setCreateTime(time());
                }
                if (!$this->isColumnModified(SessionPeer::UPDATE_TIME)) {
                    $this->setUpdateTime(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SessionPeer::UPDATE_TIME)) {
                    $this->setUpdateTime(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SessionPeer::NAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionPeer::CREATE_TIME)) $criteria->add(SessionPeer::CREATE_TIME, $this->create_time);
        if ($this->isColumnModified(SessionPeer::UPDATE_TIME)) $criteria->add(SessionPeer::UPDATE_TIME, $this->update_time);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(SessionPeer::NAME, $this->name);
